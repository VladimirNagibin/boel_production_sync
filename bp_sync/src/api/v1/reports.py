...
def build_data_row(deal: Deal) -> Generator[dict[str, Any], Any, None]:
    ...
    row: dict[str, Any] = {
        ...
        "deal_source_id": deal.source_id,
        "deal_creation_source_id": deal.creation_source_id,
    }
        ...
        row.update(
            {
                ...
                "lead_assigned_by_id": deal.lead.assigned_by_id,
                "lead_created_by_id": deal.lead.created_by_id,
                ...
                "lead_type_id": deal.lead.type_id,
                "lead_status_id": deal.lead.status_id,
                "lead_source_id": deal.lead.source_id,
            }
        )
        ...
        invoice_row.update(
            {
                ...
                "invoice_assigned_by_id": invoice.assigned_by_id,
                "invoice_created_by_id": invoice.created_by_id,
                ...
                "invoice_invoice_stage_id": invoice.invoice_stage_id,
            ...
            note_row.update(
                {
                    ...
                    "delivery_note_assigned_by_id": note.assigned_by_id,
